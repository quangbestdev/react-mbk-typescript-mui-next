    ...
    <Paper className={classes.root} elevation={3}>
      ...
      <div className={classes.content}>
        <Typography variant="body1">
          ...
          <Link className={classes.link} component="a" href="https://devias.io/privacy-policy" target="_blank">
            Privacy Policy
          </Link>
          .
        </Typography>
      ...
      <div className={classes.actions}>
        <Button className={classes.agreeButton} color="primary" onClick={handleClose} variant="contained">
          I Agree
        </Button>
      </div>
    </Paper>
