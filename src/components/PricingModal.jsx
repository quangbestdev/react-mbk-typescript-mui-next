...
import { Button, Dialog, Divider, Grid, Link, Paper, Typography, colors } from '@material-ui/core'
      ...
      <div {...rest} className={clsx(classes.root, className)}>
        <div className={classes.header}>
          ...
          <Typography align="center" className={classes.subtitle} variant="subtitle2">
            ...
            clients in the market. 30% of our income goes into Whale Charity
          </Typography>
        </div>
        <div className={classes.content}>
          <Grid container spacing={4}>
            <Grid item md={4} xs={12}>
              <Paper className={classes.product} elevation={1} onClick={onClose}>
            ...
            <Grid item md={4} xs={12}>
              <Paper className={clsx(classes.product, classes.recommended)} elevation={1} onClick={onClose}>
          ...
          <Typography align="center" className={classes.contact} variant="subtitle2">
            Have a larger team?{' '}
        ...
        <div className={classes.actions}>
          <Button className={classes.startButton} onClick={onClose} variant="contained">
