  ...
  return (
    <Card {...rest} className={clsx(classes.root, className)}>
      <CardContent className={classes.content}>
        ...
        <Grid alignItems="center" className={classes.marginTop} container justify="space-between">
          <Grid item>
            <Typography variant="h5">www.devias.io</Typography>
          </Grid>
          <Grid item>
            <Typography align="right">Invoice #{invoice.id.split('-').shift()}</Typography>
          </Grid>
        </Grid>
        ...
        <Grid className={clsx(classes.marginTop, classes.dates)} container justify="space-between">
          <Grid item>
            ...
            <Typography>{moment(invoice.due_date).format('DD MMM YYYY')}</Typography>
          </Grid>
          <Grid item>
            <Typography component="h4" gutterBottom variant="overline">
              Date of issue
            </Typography>
            <Typography>{moment(invoice.issue_date).format('DD MMM YYYY')}</Typography>
          </Grid>
          <Grid item>
            <Typography component="h4" gutterBottom variant="overline">
              Reference
