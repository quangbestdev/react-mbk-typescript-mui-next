...
import { Container, Divider, Typography, Button, Card, CardContent, colors } from '@material-ui/core'
    ...
    <Page className={classes.root} title="Modals">
      <Container maxWidth="lg">
        ...
        <div className={classes.section}>
          ...
          <Card>
            <CardContent>
              <Button color="primary" onClick={() => setOpenBase(true)} variant="contained">
                Open Base Modal
              </Button>
            </CardContent>
          </Card>
        ...
        <div className={classes.section}>
          ...
          <Card>
            <CardContent>
              <Button color="primary" onClick={() => setOpenCustomer(true)} variant="contained">
                Open Example Modal
              </Button>
            </CardContent>
          </Card>
