...
import { Checkbox, Typography, IconButton, Input, Paper, Tooltip } from '@material-ui/core'
...
function EmailToolbar({ selectedEmails, totalEmails, onSelectAll, onDeselectAll, onBack, className, ...rest }) {
  ...
  return (
    <div {...rest} className={clsx(classes.root, className)}>
      <Tooltip title="Back">
        <IconButton className={classes.backButton} onClick={onBack} size="small">
          <ArrowBackIcon />
        </IconButton>
      </Tooltip>
      ...
      <Paper className={classes.search} elevation={1}>
        ...
        <Input className={classes.searchInput} disableUnderline placeholder="Search email" />
      </Paper>
