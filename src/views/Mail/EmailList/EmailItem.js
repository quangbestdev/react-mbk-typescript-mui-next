...
function EmailItem({ email, selected, onOpen, onToggle, className, ...rest }) {
  ...
  return (
    <ListItem
      ...
      divider
    >
      <Checkbox checked={selected} className={classes.checkbox} color="primary" onChange={onToggle} />
      ...
      <div className={classes.details} onClick={onOpen}>
        ...
        <div className={classes.content}>
          <Typography className={classes.name}>{email.receiver.name}</Typography>
