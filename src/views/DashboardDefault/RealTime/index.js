  ...
  return (
    <Card {...rest} className={clsx(classes.root, className)}>
      ...
      <CardContent className={classes.content}>
        ...
        <List>
          {pages.map((page) => (
            <ListItem classes={{ divider: classes.itemDivider }} divider key={page.pathname}>
              <ListItemText primary={page.pathname} primaryTypographyProps={{ color: 'inherit', variant: 'body1' }} />
      ...
      <CardActions className={classes.actions}>
        <RouterLink href="#" passHref>
          <Button color="inherit" component="a" size="small" variant="text">
            See all
