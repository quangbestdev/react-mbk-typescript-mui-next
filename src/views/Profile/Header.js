      ...
      <Container maxWidth="lg" className={classes.container}>
        ...
        <Hidden smDown>
          <div className={classes.actions}>
            ...
            {connectedStatus === 'not_connected' && (
              <Button color="primary" onClick={handleConnectToggle} variant="contained">
                <PersonAddIcon className={classes.personAddIcon} />
                Add connection
              </Button>
            )}
            {connectedStatus === 'pending' && (
              <Button className={classes.pendingButton} onClick={handleConnectToggle} variant="contained">
                <PersonAddIcon className={classes.personAddIcon} />
                Pending connection
              </Button>
            )}
