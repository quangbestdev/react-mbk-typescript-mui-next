  ...
  return (
    <Card {...rest} className={clsx(classes.root, className)}>
      ...
      <div className={classes.search}>
        ...
        <Input className={classes.searchInput} disableUnderline placeholder="Search people &amp; places" />
      </div>
      <Divider />
            ...
            >
              <ListItemAvatar>
                <RouterLink href="/profile/[id]/[tab]" as="/profile/1/timeline" passHref>
                  <Avatar alt="Profile image" className={classes.avatar} component="a" src={connection.avatar} />
                </RouterLink>
              </ListItemAvatar>
              <ListItemText
